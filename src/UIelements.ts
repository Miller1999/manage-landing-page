...
const socialMedia = [
	{
		name: "facebook",
		text: `<ion-icon name="logo-facebook" size="large"></ion-icon>`,
	},
	{
		name: "youtube",
		text: `<ion-icon name="logo-youtube" size="large"></ion-icon>`,
	},
	{
		name: "twitter",
		text: `<ion-icon name="logo-twitter" size="large"></ion-icon>`,
	},
	{
		name: "pinterest",
		text: `<ion-icon name="logo-pinterest" size="large"></ion-icon>`,
	},
	{
		name: "instagram",
		text: `<ion-icon name="logo-instagram" size="large"></ion-icon>`,
	},
];
const createElement = (
	tagName: string,
...
const createList = (
	...
	if (elements.length !== 0) {
		elements.forEach((element) => {
			const listItem = createElement("li", classNameItem, element);
...
const createFooter = (): HTMLElement => {
	...
	const inputForm = createElement("input", "footer__form-input", "", {
